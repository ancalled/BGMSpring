...
//        }
    ...
    public int bulkSearch(String infile, String outfile, boolean withHeader, int artistRow, int trackRow)
            throws IOException {
        if (infile == null || outfile == null || artistRow < 0 || trackRow < 0) return 0;
        ...
        for (String line : lines) {
            ...
            if (withHeader && idx == 0) {
                ...
                toRowFoundData(row, sourceFields);
            }
...
//
    ...
    public static String toRowWrapped(String... fields) {
        StringBuilder buf = new StringBuilder();
        for (Object field : fields) {
            String val;
            if (field instanceof String) {
